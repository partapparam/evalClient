      ...
      <div className="flex flex-col text-black bg-white drop-shadow-md rounded-lg p-3 my-3 md:p-5">
        <div className="flex flex-row">
          <div className="w-12 h-12 sm:w-20 sm:h-20">
            ...
            https://images.unsplash.com/photo-1566438480900-0609be27a4be?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2794&q=80
            */}
            <img
